...
function saveCat() {
    ...
    // Get preferences
    const smallFreezer = document.getElementById('smallFreezer')?.checked || false;
    const preferReadyMade = document.getElementById('preferReadyMade')?.checked || false;
    const noOrgans = document.getElementById('noOrgans')?.checked || false;
    ...
    if (editingCatId) {
        ...
        // Preserve existing data like healthLogs and transitionPlan
        const existingCat = cats[index];
        catData.healthLogs = existingCat.healthLogs;
        catData.transitionPlan = existingCat.transitionPlan;
        cats[index] = catData;
    } else {
        // Add new cat
        cats.push(catData);
...
function editCat(catId) {
    ...
    // Load preferences
    if (cat.preferences) {
        document.getElementById('smallFreezer').checked = cat.preferences.smallFreezer || false;
        document.getElementById('preferReadyMade').checked = cat.preferences.preferReadyMade || false;
        document.getElementById('noOrgans').checked = cat.preferences.noOrgans || false;
    }
